...
def save_data(df, database_filename):
    ...
    """
    print('saving excel ...')
    df.to_excel(r'C:\Users\bilal\Downloads\disaster-message-classifier-master\data\output.xlsx', index=False)
    """
...
def main():
    if len(sys.argv) == 4:
        ...
        print('Please provide the filepaths of the messages and categories '\
              ...
              'emergency_messages.csv emergency_categories.csv '\
              'emergencyResponse.db')
